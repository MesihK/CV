...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
	\resumeItem{Scientific preperation}{Succesfully finished 5 course under
		    scientific preperation to Computer Science which is:
		    \textit{Object Orianted Programming, Data Structures,
		    Operating Systems, Computer Organization, Discrate Mathmatics}} 
      \resumeItemListEnd
    \resumeSubheading
	...
	\resumeItem{Swarm Unmanned Aerial Vehicle}
	  {
		  Designed hardware and developed software for a UAV telemetry modem.
			  ...
			  which can measure strength of RF signals in specified band.
		  }
      \resumeItemListEnd
...
\section{Major Projects}
  \resumeSubHeadingListStart
	...
	{Coded software for a H264 video compression device.
    ...
    \resumeSubItem{Voice Transceiver Device}
	  ...
	  Designed and produced the hardware and coded necessary \textbf{ALSA SoC driver, SoC's DMA Driver, RFIC device driver} and user space software.
	...
	{Coded software for on-board computer of the satellite.}
