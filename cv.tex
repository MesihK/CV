...
\section{Experience}
  \resumeSubHeadingListStart
	...
	find that the driver already existed, and found that with a little tweaking it just started to work. The more surprising
	thing was how powerful the shell was. It was so easy to connect little things to create a powerful beast that uses my
	hardware without even writing a line of code.
	(\textbf{Python})
	}
