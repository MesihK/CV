  ...
  \resumeSubHeadingListStart
	...
	\resumeItem{Swarm Unmanned Aerial Vehicle}
	  {
		  Designed hardware and developed software for a UAV telemetry modem.
			  Designed hardware and developed software for a RSSI Sensor
	...
	\resumeItem{UAV Modem}
	  {\begin{itemize}
		  ...
		  \item Developed MCU based control hardware and software for a RF front-end hardware.
...
\section{Major Projects}
  \resumeSubHeadingListStart
	...
	Build the required device tree.}
    \resumeSubItem{Voice Transceiver Device}
	  {A device capable of recording and sending voice at ISM band. 
	  It is an embedded Linux system that utilizes Opus codec. 
	  Designed and produced the hardware and coded necessary \textbf{ALSA SoC driver, RFIC device driver} and user space software.
	  Build the required device tree.}
